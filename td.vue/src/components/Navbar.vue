  ...
  <b-navbar toggleable="lg" fixed="top" id="navbar">
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown v-show="username" right class="cog-dropdown">
          <template #button-content>
            <font-awesome-icon icon="cog" class="td-fa-nav" style="color: white;" />
          </template>
...
<style scoped>
.cog-dropdown >>> .btn::after,
.cog-dropdown >>> .dropdown-toggle::after {
